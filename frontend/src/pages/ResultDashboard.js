...
const ResultDashboardContent = () => {
    ...
    return (
        <section className="relative mx-auto flex flex-col items-center justify-center bg-white gap-y-12 p-4 md:p-8 bg-cover bg-top bg-insight-form min-h-screen">
