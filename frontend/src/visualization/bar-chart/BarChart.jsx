...
const BarChart = ({ data, selectedCity }) => {
    ...
    // Allow users to scroll horizontally with mouse
    useEffect(() => {
    ...
    const drawBarChart = useCallback((data) => {
        ...
        if (yAxisSvg.empty()) {
            ...
            // Create y-axis label with adjusted position
            yAxisSvg.append('text')
                .attr('class', 'y-axis-label')
                .attr('y', 10)
                .attr('x', (containerHeight / 2 - marginLeft * 2.1))
        ...
        <div ref={containerRef} className="bar-chart-container w-full h-full flex flex-col">
            ...
            <div className="flex-grow flex flex-col min-h-0">
                <div className="flex-grow flex min-h-0">
                    <div 
                        ref={yAxisRef}
                        className="y-axis-container sticky left-0 bg-white"
                        style={{ 
                            width: '80px',
                            position: 'relative',
                ...
                <div className="min-h-[40px] w-[400px] flex items-center justify-center">
                    <span className="text-[0.875rem] font-bold text-primary block whitespace-nowrap">
                        City
                    </span>
                </div>
            </div>
